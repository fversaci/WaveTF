...
import math
import numpy as np
from wavetf._wavetf_conv import WaveTFFactory

# cudnn bugfix: https://github.com/tensorflow/tensorflow/issues/24496
...
class Test_Py_VS_MyWavelet():
    ...
    def kernel_1d(self, kernel, sx, float_type=np.float32) :
        ran = np.random.rand(5, sx).astype(float_type)
